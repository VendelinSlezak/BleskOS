...
%define MEMORY_NIC 0x00C00000
%define MEMORY_AHCI 0x00D00000
%define MEMORY_RAM_SCREEN 0x01000000
%define MEMORY_RAM_IMAGE_1 0x01C00000
%define MEMORY_RAM_IMAGE_2 0x01D00000
%define MEMORY_RAM_IMAGE_3 0x01E00000
%define MEMORY_RAM_IMAGE_4 0x01F00000
